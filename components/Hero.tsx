      ...
      <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
          ...
          <p className="mt-8 text-lg text-gray-700">
            ...
            Catering to the needs of Rural Minnesota, we are dedicated to
            ensuring safe, reliable, and timely transport for all our clients.
            Whether you require assistance for medical appointments or need a
            dependable transport service for daily commutes, our experienced
            team is here to facilitate your journey with utmost care and
            professionalism
          </p>
